...
function errl2 = my_l2_error (space, msh, u, uex, spex)
...
%     errl2 = errl2 + (my_l2_error (sp_col, msh_col, u, uex, spex_col, coeff)).^2;
    errl2 = errl2 + (my_l2_error (sp_col, msh_col, u, uex, spex_col)).^2;
  end
