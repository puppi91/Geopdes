% OP_UDOTN_VDOTN_TP: assemble the mass matrix M = [m(i,j)], m(i,j) = (mu u_j * n_j, v_i * n_i), exploiting the tensor product structure.
%
%   mat = op_udotn_vdotn_tp (spu, spv, msh, [coeff]);
%   [rows, cols, values] = op_udotn_vdotn_tp (spu, spv, msh, [coeff]);
%
% INPUT:
%
...
function varargout = op_udotn_vdotn_tp (space1, space2, msh, coeff)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + op_udotn_vdotn (sp1_col, sp2_col, msh_col, coeffs);
  end
