...
function [errhdiv, errl2, errhdivs, varargout] = sp_hdiv_error(space, msh, u, uex, divuex, varargin)
  ...
  if not(isempty(varargin))
    ...
    for iside = weak_drchlt_sides
       ...
       errl2_dotn_bd_square = errl2_dotn_bd_square + 1/hel*(sp_error_udotn (sp_bnd, msh_side, u, uex)).^2;
    end
  end

  % Nitsche error
if nargout > 3
    varargout{1} = sqrt(errhdiv^2+errl2_dotn_bd_square);
end
