...
%     errhdivs_elem: error in H(div) seminorm, for each single element
%
...
function [errhdiv, errl2, errhdivs, errhdiv_elem, errl2_elem, errhdivs_elem] = sp_hdiv_error_copy (sp, msh, u, uex, divuex)
